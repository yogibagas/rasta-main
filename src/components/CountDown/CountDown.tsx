...
import { Text, Heading } from 'rasta-uikit'
  ...
  return poolActive ? (
    <Col>
      ...
      <Wrapper>
        ...
        <Circle>
          <Inner>
            <Heading color="#292525" size="lg">
              {leadingZero(hours)}
            </Heading>
            <Text color="#292525">{hours === 1 ? 'hour' : 'hours'}</Text>
          </Inner>
        </Circle>
        <Circle>
          <Inner>
            ...
            <Text color="#292525">{minutes === 1 ? 'minute' : 'minutes'}</Text>
          </Inner>
        </Circle>
        <Circle>
          <Inner>
            ...
            <Text color="#292525">{seconds === 1 ? 'second' : 'seconds'}</Text>
          </Inner>
        </Circle>
      </Wrapper>
    </Col>
