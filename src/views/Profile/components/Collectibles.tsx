...
import { Heading, Text, Flex, ChevronRightIcon } from 'rasta-uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'Rasta Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'Rasta Collectibles are special ERC-721 NFTs that can be used on the RastaSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved Rasta Collectibles won't be shown here.",
        )}
      </Text>
